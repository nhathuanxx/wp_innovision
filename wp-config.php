 ...
 */
// define('WP_HOME', 'https://innovision.amintek.com.vn');
// define('WP_SITEURL', 'https://innovision.amintek.com.vn');
// Tắt hiển thị lỗi ra trang, nhưng vẫn ghi log vào wp-content/debug.log
define('WP_DEBUG', true);
define('WP_DEBUG_LOG', true);
define('WP_DEBUG_DISPLAY', false);
define('SCRIPT_DEBUG', true); // tắt debug script để tăng performance
