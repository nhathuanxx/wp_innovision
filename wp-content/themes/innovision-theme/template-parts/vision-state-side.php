<div class="edge-ai-vision-section">
  ...
  <div class="edge-ai-device-mockup">
    <img
      src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/innovision/ellipse33623-h7ggf-300h.png'); ?>"
      alt=""
      class="edge-ai-mockup-ellipse-1"
    />
    <img
      src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/innovision/ellipse43623-edyi-200h.png'); ?>"
      alt=""
      class="edge-ai-mockup-ellipse-2"
    />
    <img
      src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/innovision/rectangle13623-548c-500h.png'); ?>"
      alt=""
      class="edge-ai-mockup-rect-1"
    />
    <img
      src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/innovision/rectangle23623-ydwm-500h.png'); ?>"
      alt=""
      class="edge-ai-mockup-rect-2"
    />
    <img
      src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/innovision/industryai4x24215-xcw-400h.png'); ?>"
      alt="Industry AI"
      class="edge-ai-mockup-screen"
    />
  </div>
