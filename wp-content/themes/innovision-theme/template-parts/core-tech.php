...
.card-blue {
  background: linear-gradient(129deg, #1085F2 4%, #7BC9FC 78%);
}

.card-cyan {
  background: linear-gradient(131deg, #29AAF3 2%, #7ECDFF 79%);
}

.card-light-blue {
  background: linear-gradient(132deg, #09B9F0 3%, #8FE4FF 78%);
}
...
.card-body {
  ...
  border-radius: 12px;
  box-shadow: 0px 5px 20px 0px rgba(51, 78, 118, 0.15);
  flex: 1;
}
